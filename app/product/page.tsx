    ...
    <>
      ...
      <section className="bg-deep py-20 text-white">
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 lg:grid-cols-[1fr_1fr] lg:px-8">
          <div className="space-y-8">
            ...
            <div className="grid gap-4">
              {securityItems.map((item, index) => (
                <Reveal key={item} delay={index * 70}>
                  <div className="card-lift rounded-[1.5rem] border border-white/10 bg-white/5 px-5 py-4 text-sm leading-7 text-white/80">
                    {item}
                  </div>
                </Reveal>
              ))}
          ...
          <Reveal delay={120}>
            <div className="glass-dark card-lift border-white/10 p-8">
            ...
            <Link href="/contact" className="button-sheen mt-8 inline-flex rounded-full bg-ember px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5">
              Talk to sales
            </Link>
            </div>
          </Reveal>
