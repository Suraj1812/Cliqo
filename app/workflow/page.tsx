      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-12 px-6 py-20 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {workflowSteps.map((step, index) => (
            <div key={step.step} className="panel relative overflow-hidden p-7">
          ...
          <div className="panel p-8">
            ...
            <div className="mt-8 grid gap-4">
              {[
                ...
                <div key={item} className="rounded-[1.5rem] border border-deep/10 bg-white/75 px-5 py-4 text-sm leading-7 text-slate">
                  {item}
                </div>
              ))}
            </div>
        ...
        <div className="panel p-8">
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item.label} className="rounded-[1.5rem] border border-deep/10 bg-mist/45 px-4 py-4">
