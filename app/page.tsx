  ...
  return (
    <>
      <section className="relative overflow-hidden border-b border-deep/10 bg-gradient-to-br from-mist via-sand to-white">
        ...
        <div className="absolute left-[8%] top-20 h-48 w-48 rounded-full bg-ember/20 blur-3xl" />
        <div className="absolute right-[10%] top-28 h-64 w-64 rounded-full bg-tide/15 blur-3xl" />
        <div className="relative mx-auto grid w-full max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.12fr_0.88fr] lg:px-8 lg:py-24">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact" className="rounded-full bg-deep px-6 py-3 font-semibold text-sand transition hover:-translate-y-0.5">
                Request Demo
              </Link>
              <Link
                href="/workflow"
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              {platforms.map((platform) => (
                <span key={platform} className="metric-pill text-sm text-slate">
                  {platform}
                </span>
              ))}
            </div>
          ...
          <div className="glass-dark relative overflow-hidden p-8 text-white">
            ...
            <div className="relative space-y-7">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div
                    key={item.title}
                    className={`rounded-[1.6rem] border border-white/12 p-5 backdrop-blur-sm ${
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
            ...
            <div className="panel p-7">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                {[
                  ...
                  <span key={item} className="metric-pill text-sm text-slate">
                    {item}
                  </span>
                ))}
              </div>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {architectureLayers.map((layer) => (
              <div key={layer.name} className="panel p-6">
      ...
      <section className="mx-auto flex w-full max-w-7xl flex-col gap-12 px-6 py-20 lg:px-8">
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {workflowSteps.slice(0, 6).map((step) => (
            <div key={step.step} className="panel p-6">
        ...
        <div className="panel grid gap-8 p-8 lg:grid-cols-[0.88fr_1.12fr]">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item.label} className="rounded-[1.6rem] border border-deep/10 bg-mist/45 p-5">
        ...
        <div className="space-y-10">
          ...
          <div className="grid gap-5">
            {customers.map((customer) => (
              <div key={customer.title} className="panel p-6">
          ...
          <div className="panel p-7">
            ...
            <div className="mt-6 grid gap-4">
              {securityItems.map((item) => (
                <div key={item} className="rounded-[1.4rem] border border-deep/10 bg-white/60 px-4 py-4 text-sm text-slate">
                  {item}
                </div>
              ))}
            </div>
          ...
          <div className="glass-dark p-7 text-white">
            ...
            <div className="mt-6 space-y-4">
              {monetizationStreams.map((item) => (
                <div key={item} className="rounded-[1.5rem] border border-white/10 bg-white/5 px-4 py-4 text-sm leading-7 text-white/80">
                  {item}
                </div>
              ))}
            </div>
      ...
      <section className="border-t border-deep/10 bg-white/60 py-20">
        <div className="mx-auto grid w-full max-w-7xl gap-10 px-6 lg:grid-cols-[1fr_0.95fr] lg:px-8">
          <div className="panel grid gap-8 p-8 sm:grid-cols-[180px_1fr] sm:items-start">
            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex rounded-full bg-deep px-5 py-3 text-sm font-semibold text-sand transition hover:-translate-y-0.5"
                >
                  CEO LinkedIn
                </a>
                <a
          ...
          <div className="glass-dark flex flex-col justify-between gap-8 p-8 text-white">
            <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={item} className="rounded-[1.5rem] border border-white/10 bg-white/5 px-4 py-4 text-sm text-white/80">
                  {item}
                </div>
              ))}
            </div>
            <Link href="/contact" className="inline-flex rounded-full bg-ember px-5 py-3 text-sm font-semibold text-white transition hover:-translate-y-0.5">
              Start a partnership
            </Link>
          </div>
        </div>
